...
export default function Portfolio() {
  ...
  return (
    <div className={`${bgColor} ${textColor} min-h-screen transition-colors duration-300 relative overflow-hidden`}>
      ...
      {/* Navigation */}
      <nav className={`${navBg} border-b ${borderColor} backdrop-blur-md sticky top-0 z-50`}>
      ...
      <section className="flex items-center justify-center min-h-[calc(100vh-80px)] pt-48 relative z-10">
